...
public class ElasticsearchAggregate extends Aggregate implements ElasticsearchRel {
  ...
  /**
   * Most of the aggregations can be retrieved with single {@code stats} function. But currently
   * only one-to-one mapping is supported. This will be improved in future.
   *
   * @see <a href="https://www.elastic.co/guide/en/elasticsearch/reference/current/search-aggregations-metrics-stats-aggregation.html">stats</a>
   */
  private String toElasticAggregate(AggregateCall call) {
    // TODO change to stats (from ES)
